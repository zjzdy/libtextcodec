...
namespace zdytool {
    ...
    static int zstricmp(const char *str1, const char *str2) {
    ...
    static int zstricmp(string str1, const char *str2) { return zstricmp(str1.data(), str2); }
    ...
    static string trim(string &str) {
        ...
        int end_pos = size;
        int current_pos = 0;
        while ((current_pos < size) && (str[current_pos] == ' ')) {
            start_pos++;
            current_pos++;
        }
        if (current_pos >= size)
            return string();
        current_pos = size - 1;
        while ((current_pos > -1) && (str[current_pos] == ' ')) {
            end_pos--;
            current_pos--;
        }
        if (current_pos <= 0)
            return string();
        int result_size = end_pos - start_pos + 1;
        if (result_size > 0)
            return str.substr(start_pos, result_size);
        return string();
    }
...
#if 0
    static inline uint sjisToJisx0208(uint sjis)
    {
 ...
 */
    ...
    uint JpUnicodeConv::asciiToUnicode(uint h, uint l) const {
        if ((h == 0) && (l < 0x80)) {
            return l;
        }
        return 0x0000;
    ...
    uint JpUnicodeConv::jisx0201ToUnicode(uint h, uint l) const {
        if (h == 0) {
            if (IsLatin(l)) {
    ...
    uint JpUnicodeConv::jisx0201LatinToUnicode(uint h, uint l) const {
        if ((h == 0) && IsLatin(l)) {
    ...
    uint JpUnicodeConv::jisx0201KanaToUnicode(uint h, uint l) const {
        if ((h == 0) && IsKana(l)) {
            return jisx0201ToUnicode11(h, l);
        }
        return 0x0000;
    ...
    uint JpUnicodeConv::jisx0208ToUnicode(uint h, uint l) const {
        if (rule & UDC) {
    ...
    uint JpUnicodeConv::jisx0212ToUnicode(uint h, uint l) const {
        if (rule & UDC) {
            if ((0x75 <= h) && (h <= 0x7e) && IsJisChar(l)/*0x21 - 0x7e*/) {
                // User Defined Char (mapped to Private Use Area)
    ...
    uint JpUnicodeConv::unicodeToAscii(uint h, uint l) const {
        if ((h == 0) && (l < 0x80)) {
            return l;
        }
        return 0x0000;
    ...
    uint JpUnicodeConv::unicodeToJisx0201(uint h, uint l) const {
        uint jis;
    ...
    uint JpUnicodeConv::unicodeToJisx0201Latin(uint h, uint l) const {
    ...
    uint JpUnicodeConv::unicodeToJisx0201Kana(uint h, uint l) const {
        uint jis = unicode11ToJisx0201(h, l);
        if (IsKana(jis)) {
            return jis;
        }
    ...
    uint JpUnicodeConv::unicodeToJisx0208(uint h, uint l) const {
        if (rule & UDC) {
            uint unicode = (h << 8) | l;
 ...
 */
    ...
    class JpUnicodeConv_Unicode_ASCII : public JpUnicodeConv {
    public:
        JpUnicodeConv_Unicode_ASCII(int r) : JpUnicodeConv(r) {}
    ...
    uint JpUnicodeConv_Unicode_ASCII::jisx0208ToUnicode(uint h, uint l) const {
        if ((h == 0x21) && (l == 0x40)) {
            return 0xff3c;
        }
        return JpUnicodeConv::jisx0208ToUnicode(h, l);
    }

    uint JpUnicodeConv_Unicode_ASCII::jisx0212ToUnicode(uint h, uint l) const {
        if ((h == 0x22) && (l == 0x37)) {
            return 0xff5e;
        }
        return JpUnicodeConv::jisx0212ToUnicode(h, l);
    }

    uint JpUnicodeConv_Unicode_ASCII::unicodeToJisx0208(uint h, uint l) const {
        if ((h == 0x00) && (l == 0x5c)) {
            return 0x0000;
        }
 ...
 */
    ...
    uint JpUnicodeConv_JISX0221_JISX0201::asciiToUnicode(uint h, uint l) const {
        return jisx0201LatinToUnicode(h, l);
    }

    uint JpUnicodeConv_JISX0221_JISX0201::jisx0208ToUnicode(uint h, uint l) const {
        if ((h == 0x21) && (l == 0x3d)) {
            return 0x2014;
        }
        return JpUnicodeConv::jisx0208ToUnicode(h, l);
    ...
    uint JpUnicodeConv_JISX0221_JISX0201::unicodeToAscii(uint h, uint l) const {
 ...
 */
    ...
    uint JpUnicodeConv_JISX0221_ASCII::jisx0201LatinToUnicode(uint h, uint l) const {
        return asciiToUnicode(h, l);
    }

    uint JpUnicodeConv_JISX0221_ASCII::jisx0208ToUnicode(uint h, uint l) const {
        if (h == 0x21) {
            if (l == 0x31) {
                return 0x203e;
            } else if (l == 0x3d) {
    ...
    uint JpUnicodeConv_JISX0221_ASCII::jisx0212ToUnicode(uint h, uint l) const {
        if ((h == 0x22) && (l == 0x37)) {
            return 0xff5e;
        }
        return JpUnicodeConv::jisx0212ToUnicode(h, l);
    ...
    uint JpUnicodeConv_JISX0221_ASCII::unicodeToJisx0201Latin(uint h, uint l) const {
        return JpUnicodeConv::unicodeToAscii(h, l);
    }
    ...
    uint JpUnicodeConv_JISX0221_ASCII::unicodeToJisx0212(uint h, uint l) const {
        if ((h == 0x00) && (l == 0x7e)) {
            return 0x0000;
        }
        if ((h == 0xff) && (l == 0x5e)) {
 ...
 */
    ...
    class JpUnicodeConv_Sun : public JpUnicodeConv {
    public:
        JpUnicodeConv_Sun(int r) : JpUnicodeConv(r) {}
    ...
    uint JpUnicodeConv_Sun::jisx0201LatinToUnicode(uint h, uint l) const {
        return asciiToUnicode(h, l);
    }

    uint JpUnicodeConv_Sun::jisx0208ToUnicode(uint h, uint l) const {
        if ((h == 0x21) && (l == 0x40)) {
            return 0xff3c;
        }
        return JpUnicodeConv::jisx0208ToUnicode(h, l);
    ...
    uint JpUnicodeConv_Sun::jisx0212ToUnicode(uint h, uint l) const {
#if 1
    ...
    uint JpUnicodeConv_Sun::unicodeToAscii(uint h, uint l) const {
        if ((h == 0x00) && (l == 0xa5)) {
            return 0x005c;
    ...
    uint JpUnicodeConv_Sun::unicodeToJisx0201Latin(uint h, uint l) const {
        return JpUnicodeConv::unicodeToAscii(h, l);
    }

    uint JpUnicodeConv_Sun::unicodeToJisx0208(uint h, uint l) const {
        if ((h == 0x00) && (l == 0xa5)) {
            return 0x0000;
        } else if ((h == 0x20) && (l == 0x3e)) {
            return 0x0000;
 ...
 */
    ...
    uint JpUnicodeConv_Microsoft::jisx0201LatinToUnicode(uint h, uint l) const {
        return asciiToUnicode(h, l);
    }

    uint JpUnicodeConv_Microsoft::jisx0208ToUnicode(uint h, uint l) const {
        if (h == 0x21) {
            if (l == 0x40) {
                return 0xff3c;
            } else if (l == 0x41) {
    ...
    uint JpUnicodeConv_Microsoft::jisx0212ToUnicode(uint h, uint l) const {
        if (h == 0x22) {
            if (l == 0x37) {
                return 0xff5e;
            } else if (l == 0x43) {
    ...
    uint JpUnicodeConv_Microsoft::unicodeToJisx0201Latin(uint h, uint l) const {
        return JpUnicodeConv::unicodeToAscii(h, l);
    }
    ...
    JpUnicodeConv *JpUnicodeConv::newConverter(int rule) {
        char *env_v = std::getenv("UNICODEMAP_JP");
        string env = env_v ? env_v : "";
        if (rule == Default && !env.empty()) {
            for (int i = 0; i < (int) env.length();) {
                ...
                if (zstricmp(s, "unicode-0.9") == 0) {
                    rule = (rule & 0xff00) | Unicode;
                } else if (zstricmp(s, "unicode-0201") == 0) {
                    rule = (rule & 0xff00) | Unicode_JISX0201;
                } else if (zstricmp(s, "unicode-ascii") == 0) {
                    rule = (rule & 0xff00) | Unicode_ASCII;
                } else if (zstricmp(s, "jisx0221-1995") == 0) {
                    rule = (rule & 0xff00) | JISX0221_JISX0201;
                } else if ((zstricmp(s, "open-0201") == 0) ||
                           (zstricmp(s, "open-19970715-0201") == 0)) {
                    rule = (rule & 0xff00) | JISX0221_JISX0201;
                } else if ((zstricmp(s, "open-ascii") == 0) ||
                           (zstricmp(s, "open-19970715-ascii") == 0)) {
                    rule = (rule & 0xff00) | JISX0221_ASCII;
                } else if ((zstricmp(s, "open-ms") == 0) ||
                           (zstricmp(s, "open-19970715-ms") == 0)) {
                    rule = (rule & 0xff00) | Microsoft_CP932;
                } else if (zstricmp(s, "cp932") == 0) {
                    rule = (rule & 0xff00) | Microsoft_CP932;
                } else if (zstricmp(s, "jdk1.1.7") == 0) {
                    rule = (rule & 0xff00) | Sun_JDK117;
                } else if (zstricmp(s, "nec-vdc") == 0) {
                    rule = rule | NEC_VDC;
                } else if (zstricmp(s, "ibm-vdc") == 0) {
                    rule = rule | IBM_VDC;
                } else if (zstricmp(s, "udc") == 0) {
                    rule = rule | UDC;
                }
            }
        }
        ...
        switch (rule & 0x00ff) {
            case Unicode_JISX0201:
                return new JpUnicodeConv_Unicode_JISX0201(rule);
            case Unicode_ASCII:
                return new JpUnicodeConv_Unicode_ASCII(rule);
            case JISX0221_JISX0201:
                return new JpUnicodeConv_JISX0221_JISX0201(rule);
            case JISX0221_ASCII:
                return new JpUnicodeConv_JISX0221_ASCII(rule);
            case Sun_JDK117:
                return new JpUnicodeConv_Sun(rule);
            case Microsoft_CP932:
                return new JpUnicodeConv_Microsoft(rule);
            default:
                return new JpUnicodeConv_Unicode_ASCII(rule);
        }
    }
 ...
 */
    ...
    uint JpUnicodeConv::sjisibmvdcToUnicode(uint h, uint l) const {
    ...
    uint JpUnicodeConv::unicodeToSjisibmvdc(uint h, uint l) const {
    ...
    uint JpUnicodeConv::cp932ToUnicode(uint h, uint l) const {
    ...
    uint JpUnicodeConv::unicodeToCp932(uint h, uint l) const {
        if ((rule & Microsoft_CP932)) {
            uint u = (h << 8) | l;
            //since there is no direct mapping, do a linear search
